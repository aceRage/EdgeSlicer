...
const std::vector<std::pair<GCodeProcessor::EProducer, std::string>> GCodeProcessor::Producers = {
    ...
    // Upstream OrcaSlicer shares our config block format. Without this entry its
    // producer string matched none of the entries above, apply_config was skipped
    // entirely and extruders_count stayed 0 (all T commands rejected as invalid).
    { EProducer::Snapmaker_Orca, "generated by OrcaSlicer" },
