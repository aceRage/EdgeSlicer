...
public:
    ...
    void set_curved_color_clip(unsigned int tex, const Transform3d& world_to_plane, double half_size, double range = 0.) { m_volumes.set_curved_color_clip(tex, world_to_plane, half_size, range); }
