...
{
    m_device_url = wxString::FromUTF8(wxGetApp().page_url("/web/flutter_web/index.html?path=discovery"));

    SetBackgroundColour(*wxWHITE);

    // Create blank; run() loads the localized URL once (same pattern as WebPreprintDialog / SM #865).
