...
std::string find_selectable_full_spectrum_family_preset(const std::string& family_name)
{
    ...
    // suffix and the @vendor tag), never by name composition: composing
    // "family + nozzle + nozzle" would re-encode the naming convention and inherit
    // its case-sensitivity pitfalls (see #742, the U1 preset filename case mismatch).
