...
/*#ifdef __WXOSX__
    ...
    {
        enum class EditScope { ActiveMode, Both };
...
protected:
    ...
    void destroy_flow_variant_header_controls();
    bool flow_variant_both_allowed() const;
    int  flow_variant_selector_index() const;
    void on_flow_variant_segment_selected(int index);
    bool enter_flow_variant_both();
    void on_copy_standard_to_high_flow();
    void maybe_dual_write_flow_variant(const std::string& opt_key);
