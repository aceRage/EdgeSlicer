...
{
    m_prePrint_url = wxString::FromUTF8(wxGetApp().page_url("/web/flutter_web/index.html?path=4"));

    m_preSend_url = wxString::FromUTF8(wxGetApp().page_url("/web/flutter_web/index.html?path=5"));
