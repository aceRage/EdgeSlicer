...
// Only the Bambu Device page uses these switches: Bambu Studio's green hover ring.
static const wxColour DEFAULT_HOVER_COL = Slic3r::GUI::BambuDevicePalette::Green;
