...
#include "GUI_App.hpp"
#include "GUI.hpp" // into_u8 for locale-key lookup in color_name_for_lang
#include "I18N.hpp"
...
//
// Compare in the GetFilamentMatchName space so "... @U1" library names match the
// default-family form produced by default_full_spectrum_family_name().
//
...
{
    if (GetFilamentMatchName(entry.family_name) == default_full_spectrum_family_name())
